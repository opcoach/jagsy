 ...
 * </p>
 * <ul>
 *   <li>{@link com.opcoach.bugsy.xtext.bugsDsl.impl.ArrayRangeImpl#getLow <em>Low</em>}</li>
 *   <li>{@link com.opcoach.bugsy.xtext.bugsDsl.impl.ArrayRangeImpl#getHigh <em>High</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayRangeImpl extends MinimalEObjectImpl.Container implements ArrayRange
{
  ...
  {
    return BugsDslPackage.Literals.ARRAY_RANGE;
  }
  ...
  public void setLow(String newLow)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BugsDslPackage.ARRAY_RANGE__LOW, oldLow, low));
  }
  ...
  public void setHigh(String newHigh)
  {
    ...
    high = newHigh;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BugsDslPackage.ARRAY_RANGE__HIGH, oldHigh, high));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BugsDslPackage.ARRAY_RANGE__LOW:
        return getLow();
      case BugsDslPackage.ARRAY_RANGE__HIGH:
        return getHigh();
    }
