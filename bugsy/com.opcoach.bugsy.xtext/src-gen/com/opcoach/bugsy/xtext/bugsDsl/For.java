...
public interface For extends Instruction
{
   ...
   * @see com.opcoach.bugsy.xtext.bugsDsl.BugsDslPackage#getFor_Variable()
   * @model
   * @generated
   */
  String getVariable();
  ...
  /**
   * Sets the value of the '{@link com.opcoach.bugsy.xtext.bugsDsl.For#getVariable <em>Variable</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
