...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Function Operator</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see com.opcoach.bugsy.xtext.bugsDsl.BugsDslPackage#getFunctionOperator()
 * @model
 * @generated
 */
public enum FunctionOperator implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final FunctionOperator[] VALUES_ARRAY =
  ...
  /**
   * A public read-only list of all the '<em><b>Function Operator</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<FunctionOperator> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Function Operator</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static FunctionOperator get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      FunctionOperator result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Function Operator</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
   * @generated
   */
  public static FunctionOperator getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      FunctionOperator result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Function Operator</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static FunctionOperator get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private FunctionOperator(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
